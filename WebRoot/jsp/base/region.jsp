	...
	$(function(){
	    ...
	    //导入
	    	$("#button-import").upload({
	    		action:"${pageContext.request.contextPath }/regionAction_adds",
	  	 		name:"myfile"
	   		 });
	});
...
<body>
	...
	<div closed="true" class="easyui-window easyui-layout" title="区域添加修改" id="addRegionWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
