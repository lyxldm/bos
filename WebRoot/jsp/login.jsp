...
<script type="text/javascript">
	...
	//验证码的刷新
	function change(){
		document.getElementById('loginform:vCode').src='${pageContext.request.contextPath }/jsp/validatecode.jsp?'+Math.random()
	}
</script>
</head>
<body>
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						...
						<input id="loginform:idInput" type="text" name="user_name"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							...
							<img id="loginform:vCode" src="${pageContext.request.contextPath }/jsp/validatecode.jsp"
								onclick="change()" />
						</div>
