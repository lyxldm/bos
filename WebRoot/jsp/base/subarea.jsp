...
<body>
	<div id="grid" region="center" border="false">
	
	</div>
	<!-- 添加 修改分区 -->
	<div closed="true" class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="form1" action="${pageContext.request.contextPath}/subareaAction_add">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="url:'${pageContext.request.contextPath }/regionAction_list', valueField:'id', textField:'show',mode:'remote'"/>  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<!-- 查询分区 -->
	<div closed="true" class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false">
			<form>
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
